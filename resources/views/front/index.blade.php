            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row justify-content-around gy-4">
                    <div class="col-lg-6 img-bg"
                        style="background-image: url(assets/front/assets/img/alt-services.jpg);" data-aos="zoom-in"
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active show" id="tab-1">
                        <div class="row">
                            ...
                            <div class="col-lg-6 order-1 order-lg-2 text-center" data-aos="fade-up"
                                data-aos-delay="200">
                                <img src="{{ asset('assets/front/assets/img/features-1.jpg') }}" alt=""
                                    class="img-fluid">
                            </div>
                        </div>
                    ...
                    <div class="tab-pane" id="tab-2">
                        <div class="row">
                            ...
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="{{ asset('assets/front/assets/img/features-2.jpg') }}" alt=""
                                    class="img-fluid">
                            </div>
                        </div>
                    </div><!-- End tab content item -->
                    ...
                    <div class="tab-pane" id="tab-3">
                        <div class="row">
                            ...
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="{{ asset('assets/front/assets/img/features-3.jpg') }}" alt=""
                                    class="img-fluid">
                            </div>
                        </div>
                    </div><!-- End tab content item -->
                    ...
                    <div class="tab-pane" id="tab-4">
                        <div class="row">
                            ...
                            <div class="col-lg-6 order-1 order-lg-2 text-center">
                                <img src="{{ asset('assets/front/assets/img/features-4.jpg') }}" alt=""
                                    class="img-fluid">
                            </div>
                        </div>
                    </div><!-- End tab content item -->
                ...
                <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry"
                    ...
                    <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-repairs">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('assets/front/assets/img/projects/repairs-1.jpg') }}"
                                    class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>Repairs 1</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-design">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('assets/front/assets/img/projects/design-1.jpg') }}"
                                    class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>Design 1</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                                    <a href="{{ asset('assets/front/assets/img/projects/design-1.jpg') }}"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-repairs">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('assets/front/assets/img/projects/repairs-2.jpg') }}"
                                    class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>Repairs 2</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-design">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('assets/front/assets/img/projects/design-2.jpg') }}"
                                    class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>Design 2</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                                    <a href="{{ asset('assets/front/assets/img/projects/design-2.jpg') }}"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-repairs">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('assets/front/assets/img/projects/repairs-3.jpg') }}"
                                    class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>Repairs 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item filter-design">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('assets/front/assets/img/projects/design-3.jpg') }}"
                                    class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>Design 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                                    <a href="{{ asset('assets/front/assets/img/projects/design-3.jpg') }}"
