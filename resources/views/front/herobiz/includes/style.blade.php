<!-- Favicons -->
<link href="{{ asset('assets/front/herobiz/assets/img/favicon.png') }}" rel="icon">
<link href="{{ asset('assets/front/herobiz/assets/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
