<!-- jequery plugins -->
<script src="{{ asset('assets/front/appway/js/jquery.js') }}"></script>
<script src="{{ asset('assets/front/appway/js/popper.min.js') }}"></script>
<script src="{{ asset('assets/front/appway/js/bootstrap.min.js') }}"></script>
